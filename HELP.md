...
* The original package name 'WebSocket.example.One-on-One Chat Application' is invalid and this project uses 'WebSocket.example.One_on_One.Chat.Application' instead.
